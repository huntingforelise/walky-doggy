...
originalService.fetchEventRecords = (_id) => {
  return fetch(`${BASE_URL}/records/${_id}`, {
    method: 'GET',
    credentials: 'include',
    mode: 'cors',
    headers: { 'Content-Type': 'application/json' },
...
originalService.fetchEventImages = (_id) => {
  return fetch(`${BASE_URL}/images/${_id}`, {
    method: 'GET',
    credentials: 'include',
    mode: 'cors',
    headers: { 'Content-Type': 'application/json' },
...
originalService.fetchRecord = (_id) => {
  return fetch(`${BASE_URL}/records/${_id}`, {
    method: 'GET',
    credentials: 'include',
    mode: 'cors',
