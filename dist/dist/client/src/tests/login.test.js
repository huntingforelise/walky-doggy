...
test("loads and displays login", function () {
    render(React.createElement(Login, null), { wrapper: MemoryRouterProvider });
...
describe('Login Component', function () {
    it('should log in successfully and redirect to the correct page', function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = render(React.createElement(Login, null)), getByLabelText = _a.getByLabelText, getByText = _a.getByText;
