...
var formuser = function () {
    ...
    //   });
    // });
    return (React.createElement(React.Fragment, null, React.createElement("h2", { className: styles.title }, "Walk Record"), React.createElement("div", { className: "record-div-outer" }, walkRecord.poo !== undefined && walkRecord.pee !== undefined ? (React.createElement("div", { className: "record-div" }, React.createElement("label", null, "POO: ", walkRecord.poo, " "), React.createElement("label", null, "PEE: ", walkRecord.pee, " "))) : ("We unfortunately don't have any pee or poo data yet!"))));
};
