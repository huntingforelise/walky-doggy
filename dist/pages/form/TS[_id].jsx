    ...
    return (<>
          ...
          <div>
            <div>
              <div className="submit-form-control">
                ...
                <input type="checkbox" name="pee" value={pee} checked={true} onChange={function (e) { return setPee(e.target.checked); }}/>
              </div>
              <div>
                <div className="submit-form-control">
                  <label>POO</label>
                  <input type="checkbox" name="poo" value={poo} onChange={function (e) { return setPoo(e.target.checked); }}/>
                </div>
              </div>
            </div>
      ...
      <div className="upload-container-outer">
        <div className="upload-container">
          <div>
            <input type="file" onChange={function (e) { return setImage(e.target.files[0]); }}></input>
