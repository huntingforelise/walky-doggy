    ...
    return (<>
      ...
      <form className="add-form" onSubmit={onSubmit}>
        <div className="form-control">
          ...
          <input type="text" name="title" placeholder="your dog's name" required value={dogName} onChange={function (e) { return setDogName(e.target.value); }}/>
        </div>
        <div className="form-control">
          <label>DATE</label>
          <DatePicker className="date-picker" showTimeSelect required selected={date} onSelect={function (date) { return setDate(date); }} //when day is clicked
     onChange={function (date) { return setDate(date); }} //only when value has changed
     dateFormat="Pp"/>
        </div>
        <div className="form-control">
          <label>PICK-UP LOCATION</label>
          <input type="text" name="venue" placeholder="pick up address" required value={pickUpLocation} onChange={function (e) { return setPickUpLocation(e.target.value); }}/>
        </div>
