...
jest.mock("../services/WalkServiceDEL", function () {
    return {
        postWalk: jest.fn(function () { return Promise.resolve({}); }),
    };
});
describe("Book component", function () {
    test("renders form elements", function () {
        var getByPlaceholderText = render(<Book />).getByPlaceholderText;
...
//# sourceMappingURL=owneraccount-book.test.js.map