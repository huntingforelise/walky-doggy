    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("div", { className: "myaccount" },
            ...
            React.createElement(Link, { href: "/owneraccount/upcoming" },
                React.createElement("button", { className: styles.buttonselected }, "Upcoming Walks"))),
        React.createElement(WalkList, { walks: futureWalks, onDelete: deleteWalk, formPath: "/form/", ownerUpcoming: true })));
};
