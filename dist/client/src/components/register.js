    ...
    return (React.createElement("section", null,
        React.createElement("div", { className: "form-control", style: { textAlign: "center" } },
            React.createElement("form", { className: "add-form", onSubmit: handleSubmit },
                React.createElement("label", { style: { display: "inline-block", textAlign: "center" } },
                    "Dog Owner",
                    React.createElement("input", { type: "checkbox", name: "isOwner", checked: state.isOwner, onChange: handleCheckChange })),
                React.createElement("label", { style: { display: "inline-block" } },
                    React.createElement("span", null, "Dog Walker"),
                    React.createElement("input", { type: "checkbox", name: "isWalker", checked: state.isWalker, onChange: handleCheckChange })),
                React.createElement("label", null,
                    "Username",
                    React.createElement("input", { type: "text", placeholder: "username", name: "username", value: state.username, onChange: handleChange, autoComplete: "off" })),
                React.createElement("label", null,
                    "E-mail",
                    React.createElement("input", { type: "text", placeholder: "name@mail.com", name: "email", value: state.email, onChange: handleChange, autoComplete: "off" })),
                React.createElement("label", null,
                    "Password",
                    React.createElement("input", { type: "password", placeholder: "******", name: "password", value: state.password, onChange: handleChange })),
                React.createElement("div", { className: "login-container" },
                    React.createElement("button", { className: "btn-clicked", type: "submit", disabled: validateForm() }, "Register"))),
